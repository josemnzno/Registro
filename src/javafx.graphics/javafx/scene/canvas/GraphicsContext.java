...
package javafx.graphics.javafx.scene.canvas;
 ...
 * </td></tr>
 * <tr class="rowColor">
 * <th scope="row" class="colLast" style="width:15%">{@link #setGlobalBlendMode(BlendMode) Global Blend Mode}</th>
 * <td class="colLast" style="width:10%; text-align:center; color:#0c0">Yes</td>
 ...
 * </td></tr>
 * <tr class="altColor">
 * <th scope="row" class="colLast" style="width:15%">{@link #setTransform(Affine) Transform}</th>
 * <td class="colLast" style="width:10%; text-align:center; color:#0c0">Yes</td>
 ...
 * </td></tr>
 * <tr class="rowColor">
 * <th scope="row" class="colLast" style="width:15%">{@link #setEffect(Effect) Effect}</th>
 * <td class="colLast" style="width:10%; text-align:center; color:#0c0">Yes</td>
 ...
 * </td></tr>
 * <tr class="rowColor">
 * <th scope="row" class="colLast" style="width:15%">{@link #setTextBaseline(VPos) Text Baseline}</th>
 * <td class="colLast" style="width:10%; text-align:center; color:#0c0">Yes</td>
 ...
 * <tr class="rowColor">
 * <th scope="row" class="colLast" style="width:22%">
 * {@link #fillText(String, double, double) fillText()},
 * {@link #fillText(String, double, double, double) fillText(with maxWidth)}
 * </th>
 * <td class="colLast" style="width:13%; text-align:center; color:#0c0">Yes</td>
 * <td class="colLast" style="width:13%; text-align:center; color:#0c0">Yes</td>
 * <td class="colLast" style="width:13%; text-align:center; color:#c00">No</td>
 ...
 * <tr class="altColor">
 * <th scope="row" class="colLast" style="width:22%">
 * {@link #strokeText(String, double, double) strokeText()},
 * {@link #strokeText(String, double, double, double) strokeText(with maxWidth)}
 * </th>
 * <td class="colLast" style="width:13%; text-align:center; color:#0c0">Yes</td>
 * <td class="colLast" style="width:13%; text-align:center; color:#c00">No</td>
 * <td class="colLast" style="width:13%; text-align:center; color:#0c0">Yes</td>
 ...
 * {@link #appendSVGPath(String) appendSVGPath()},
 ...
 * <tr class="rowColor">
 * <th scope="row" class="colLast" style="width:22%">
 * {@link #applyEffect(Effect) applyEffect()},
