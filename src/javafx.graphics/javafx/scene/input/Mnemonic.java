...
package javafx.graphics.javafx.scene.input;
 ...
 * The Mnemonic is constructed with a {@link Node Node} and a {@link KeyCombination}.
...
public class Mnemonic {
    ...
    /**
     * Constructs a {@code Mnemonic} with the specified target {@link Node Node}
     * and trigger {@link KeyCombination}.
     *
     * @param node the {@link Node Node} that will receive the {@link javafx.event.ActionEvent ActionEvent}.
    ...
    /**
     * Returns the {@link Node Node}
     * @return the {@code Node}
     */
    public Node getNode() { return node; }

    /**
     * Sets the {@link Node Node}
