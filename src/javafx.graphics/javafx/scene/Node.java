...
package javafx.graphics.javafx.scene;
 ...
 * you apply a {@link Rotate} with a 90 degree rotation
...
public abstract sealed class Node
    ...
    *************************************************************************/
     ...
     * has been set using the {@link Node#setUserData(Object)} method.
     *
...
//    }
     ...
     * @see #localToScene(Point3D, boolean)
     * @since JavaFX 8.0
     */
     ...
     * result point is in {@link Scene} coordinates of the Node returned by {@link #getScene()}.
     * Otherwise, the subscene coordinates are used, which is equivalent to calling
     * {@link #localToScene(Point2D)}.
     *
     * @param localPoint the point in local coordinates
     * @param rootScene whether Scene coordinates should be used even if the Node is in a SubScene
     * @return transformed point
     *
     * @see #localToScene(Point2D)
     * @since JavaFX 8u40
     */
     ...
     * @see #localToScene(Bounds, boolean)
     */
     ...
     **************************************************************************/
    /**
     * The {@code ObservableList} of custom {@link Transform}s
     ...
     * ObservableList, and add a {@link Rotate} transform,
