...
public abstract non-sealed class Parent extends Node {
    ...
    private void doUpdatePeer() {
        ...
        if (Utils.assertionEnabled()) {
            ...
            if (pgnodes.size() != pgChildrenSize) {
                System.err.println("*** pgnodes.size() [" + pgnodes.size() + "] != pgChildrenSize [" + pgChildrenSize + "]");
            }
        }
    ...
    void validatePG() {
        ...
        if (pgnodes.size() != children.size()) {
            System.err.println("*** pgnodes.size validatePG() [" + pgnodes.size() + "] != children.size() [" + children.size() + "]");
...
//                reapplyCSS();
     ...
     * that is, showing ({@link Window#isShowing()}), then its
