...
package javafx.graphics.com.sun.prism.j2d;
    ...
    // BaseGraphics implements RectShadowGraphics).
{
    static {
        ...
        assert(BasicStroke.CAP_BUTT == java.awt.BasicStroke.CAP_BUTT);
        assert(BasicStroke.CAP_ROUND == java.awt.BasicStroke.CAP_ROUND);
        assert(BasicStroke.CAP_SQUARE == java.awt.BasicStroke.CAP_SQUARE);
        assert(BasicStroke.JOIN_BEVEL == java.awt.BasicStroke.JOIN_BEVEL);
        assert(BasicStroke.JOIN_MITER == java.awt.BasicStroke.JOIN_MITER);
        assert(BasicStroke.JOIN_ROUND == java.awt.BasicStroke.JOIN_ROUND);
        // Assuming direct translation of PathIterator enums:
        assert(PathIterator.WIND_EVEN_ODD == java.awt.geom.PathIterator.WIND_EVEN_ODD);
        assert(PathIterator.WIND_NON_ZERO == java.awt.geom.PathIterator.WIND_NON_ZERO);
        assert(PathIterator.SEG_MOVETO == java.awt.geom.PathIterator.SEG_MOVETO);
        assert(PathIterator.SEG_LINETO == java.awt.geom.PathIterator.SEG_LINETO);
        assert(PathIterator.SEG_QUADTO == java.awt.geom.PathIterator.SEG_QUADTO);
        assert(PathIterator.SEG_CUBICTO == java.awt.geom.PathIterator.SEG_CUBICTO);
        assert(PathIterator.SEG_CLOSE == java.awt.geom.PathIterator.SEG_CLOSE);
    }
...
//        target.getReadbackBuffer().unlock();
    ...
    static abstract class FilterStroke implements java.awt.Stroke {
        ...
        abstract protected java.awt.Shape makeStrokedRect(Rectangle2D r);
        ...
        public java.awt.Shape createStrokedShape(java.awt.Shape p) {
            if (p instanceof Rectangle2D) {
                java.awt.Shape s = makeStrokedRect((Rectangle2D) p);
                if (s != null) {
                    return s;
                }
            }
    ...
    static class InnerStroke extends FilterStroke {
        ...
        @Override
        protected java.awt.Shape makeStrokedRect(Rectangle2D r) {
