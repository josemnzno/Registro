...
package javafx.graphics.com.sun.javafx.text;
...
public class PrismTextLayout implements TextLayout {
    ...
    @Override
    public CaretGeometry getCaretGeometry(int offset, boolean isLeading) {
        ensureLayout();
        int lineIndex = 0;
            ...
            for (int i = 0; i < runs.length; i++) {
                ...
                if (runStart <= splitCaretOffset && splitCaretOffset < runEnd) {
                    if ((run.getLevel() & 1) != (level & 1)) {
                        ...
                        // split caret
                        return new CaretGeometry.Split(
                            lineX,
                            lineX2,
                            lineY,
                            lineHeight
        ...
        // regular caret
        return new CaretGeometry.Single(
            lineX,
            lineY,
            lineHeight
        );
