...
package javafx.graphics.com.sun.javafx.geom;
...
public class CubicCurve2D extends Shape {
    ...
    public int hashCode() {
        ...
        bits += Float.floatToIntBits(ctrlx1) * 53;
        bits += Float.floatToIntBits(ctrly1) * 59;
        bits += Float.floatToIntBits(ctrlx2) * 61;
        bits += Float.floatToIntBits(ctrly2) * 101;
        return bits;
    }
