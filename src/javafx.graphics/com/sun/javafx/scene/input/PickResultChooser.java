...
package javafx.graphics.com.sun.javafx.scene.input;
...
public class PickResultChooser {
     ...
     * @see PickResultChooser#offer(Node, double, int, Point3D, Point2D)
     * @see PickResultChooser#offer(Node, double, Point3D)
     * @param node The intersected node
