...
package jfx.incubator.richtext.jfx.incubator.scene.control.richtext.model;
 ...
 * <p>
 * This model supports custom content storage mechanism via {@link Content}.  By default,
 * the model provides an in-memory storage via its {@link InMemoryContent} implementation.
 *
 * @since 24
 */
public class BasicTextModel extends StyledTextModel {
     ...
     * <p>
     * This method calls {@link Content#isWritable()}.
     *
