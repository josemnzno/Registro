...
package jfx.incubator.richtext.com.sun.jfx.incubator.scene.control.richtext;
...
class VFlowCellContext implements CellContext {
    ...
    @Override
    public <T> void decorateRun(StyleAttribute<T> a, RunDecor type, String styleName) {
