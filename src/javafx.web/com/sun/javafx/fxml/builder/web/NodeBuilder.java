...
package javafx.web.com.sun.javafx.fxml.builder.web;
...
public abstract class NodeBuilder<B extends NodeBuilder<B>> {
    ...
    */
    @SuppressWarnings("unchecked")
    public B style(String x) {
        this.style = x;
        __set(62);
        return (B) this;
    }

    private java.util.Collection<? extends String> styleClass;
    /**
    ...
    */
    @SuppressWarnings("unchecked")
    public B styleClass(java.util.Collection<? extends String> x) {
        this.styleClass = x;
        __set(63);
        return (B) this;
    }
