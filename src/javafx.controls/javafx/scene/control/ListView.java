...
public class ListView<T> extends Control {
    ...
    private EventHandler<EditEvent<T>> DEFAULT_EDIT_COMMIT_HANDLER = t -> {
     ...
     * {@link ListCell#commitEdit(Object)} method.
     *
     * <p>This is a convenience method - the same result can be
     * achieved by calling
     * <code>addEventHandler(ListView.EDIT_START_EVENT, eventHandler)</code>.
     ...
     * instead call {@link ListCell#commitEdit(Object)} from within
