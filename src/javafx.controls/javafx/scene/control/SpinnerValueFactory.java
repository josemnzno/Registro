 ...
 *
 * <ul>
 *     <li>{@link IntegerSpinnerValueFactory}</li>
 *     <li>{@link DoubleSpinnerValueFactory}</li>
 *     <li>{@link ListSpinnerValueFactory}</li>
 * </ul>
 *
...
public abstract class SpinnerValueFactory<T> {
     ...
     * });</pre>
     *
     * @param <T> The type of the elements in the {@link List}.
     * @since JavaFX 8u40
     */
     ...
     * within it a {@link DecimalFormat} instance that shows the Double
