...
public class TreeTableViewBehavior<T> extends TableViewBehaviorBase<TreeTableView<T>, TreeItem<T>, TreeTableColumn<T, ?>> {
    ...
    private final ChangeListener<TreeTableViewSelectionModel<T>> selectionModelListener =
    ...
    private final WeakChangeListener<TreeTableViewSelectionModel<T>> weakSelectionModelListener =
