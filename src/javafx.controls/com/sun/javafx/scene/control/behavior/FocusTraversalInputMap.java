 ...
 * questions.
 */
package javafx.controls.com.sun.javafx.scene.control.behavior;
...
public class FocusTraversalInputMap {
    ...
    public static Mapping<?>[] getFocusTraversalMappings() {
    ...
    public static final void traverseUp(KeyEvent e) {
        traverse(getNode(e), Direction.UP, TraversalMethod.KEY);
    }
    ...
    public static final void traverseDown(KeyEvent e) {
        traverse(getNode(e), Direction.DOWN, TraversalMethod.KEY);
    }
    ...
    public static final void traverseLeft(KeyEvent e) {
        traverse(getNode(e), Direction.LEFT, TraversalMethod.KEY);
    }
    ...
    public static final void traverseRight(KeyEvent e) {
        traverse(getNode(e), Direction.RIGHT, TraversalMethod.KEY);
    }
    ...
    public static final void traverseNext(KeyEvent e) {
        traverse(getNode(e), Direction.NEXT, TraversalMethod.KEY);
    }
    ...
    public static final void traversePrevious(KeyEvent e) {
        traverse(getNode(e), Direction.PREVIOUS, TraversalMethod.KEY);
    }
