...
package javafx.base.javafx.collections;
...
public class FXCollections {
     ...
     * {@link Collections#sort(List) Collections.sort(List)}.
     * Fires only <b>one</b> change notification on the list.
     *
    ...
    /**
     * Sorts the provided observable list as specified in
     * {@link Collections#sort(List, Comparator) Collections.sort(List, Comparator)}.
     * Fires only <b>one</b> change notification on the list.
     *
     * @param <T> the type of elements in this list
    ...
    private static class CheckedObservableMap<K, V> extends AbstractMap<K, V> implements ObservableMap<K, V> {
        ...
        public void putAll(Map<? extends K, ? extends V> t) {
            ...
            for (Object o : entries) {
                ...
                typeCheck(k, v);
                checked.add(
                    new SimpleImmutableEntry<>((K) k, (V) v));
            }
